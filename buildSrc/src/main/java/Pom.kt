...
object Pom {
    ...
    const val SCM_URL = "https://github.com/jeffdcamp/android-commons/"
    const val SCM_CONNECTION = "scm:git:git://github.com/jeffdcamp/android-commons.git"
    const val SCM_DEV_CONNECTION = "scm:git:git@github.com:jeffdcamp/android-commons.git"
    ...
    const val LIBRARY_ARTIFACT_ID = "android-commons"
    const val LIBRARY_NAME = "Android Commons"
}
